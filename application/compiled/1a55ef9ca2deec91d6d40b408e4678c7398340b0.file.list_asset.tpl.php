<?php /* Smarty version Smarty-3.1.7, created on 2018-01-23 06:09:41
         compiled from "C:\wamp\www\research\iScaffoldnov6\output\fixed_asset\application\views\list_asset.tpl" */ ?>
<?php /*%%SmartyHeaderCode:161955a66c3953f6883-20393497%%*/
if (!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array(
    'file_dependency' =>
        array(
            '1a55ef9ca2deec91d6d40b408e4678c7398340b0' =>
                array(
                    0 => 'C:\\wamp\\www\\research\\iScaffoldnov6\\output\\fixed_asset\\application\\views\\list_asset.tpl',
                    1 => 1516683066,
                    2 => 'file',
                ),
        ),
    'nocache_hash' => '161955a66c3953f6883-20393497',
    'function' =>
        array(),
    'variables' =>
        array(
    ...
    'unifunc' => 'content_5a66c3958c504',
), false); /*/%%SmartyHeaderCode%%*/ ?>
<?php if ($_valid && !is_callable('content_5a66c3958c504')) {
    function content_5a66c3958c504($_smarty_tpl)
    { ?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\wamp\\www\\research\\iScaffoldnov6\\output\\fixed_asset\\application\\libraries\\smarty\\plugins\\function.cycle.php';
        ?><!-- CUSTOM -->
                ...
                <form action="asset/delete" method="post" id="listing_form">
                    <div class="table-responsive">
                        <table class="table exportable" id="asset" name="asset">
                            ...
                            $_from = $_smarty_tpl->tpl_vars['asset_data']->value;
...
">
                                    <td><input type="checkbox" class="checkbox" name="delete_ids[]"
                                               value="<?php echo $_smarty_tpl->tpl_vars['row']->value['ass_id']; ?>
"/></td>
                        ...
                        <div class="actions-bar wat-cf">
                            <div class="actions">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['showall']->value == 0) { ?>
                                    <a href="asset/index/0/all" class="btn btn-xs btn-success show-all"><i

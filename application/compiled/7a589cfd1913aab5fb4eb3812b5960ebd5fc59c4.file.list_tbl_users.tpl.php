<?php /* Smarty version Smarty-3.1.7, created on 2018-01-23 06:22:54
         compiled from "C:\wamp\www\research\iScaffoldnov6\output\fixed_asset\application\views\list_tbl_users.tpl" */ ?>
<?php /*%%SmartyHeaderCode:222655a66c66faf5fa8-89052128%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a589cfd1913aab5fb4eb3812b5960ebd5fc59c4' => 
    array (
      0 => 'C:\\wamp\\www\\research\\iScaffoldnov6\\output\\fixed_asset\\application\\views\\list_tbl_users.tpl',
      1 => 1516684970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '222655a66c66faf5fa8-89052128',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a66c66fd99cc',
  'variables' => 
  array (
    'search_result' => 0,
    'table_name' => 0,
...
<?php if ($_valid && !is_callable('content_5a66c66fd99cc')) {function content_5a66c66fd99cc($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\wamp\\www\\research\\iScaffoldnov6\\output\\fixed_asset\\application\\libraries\\smarty\\plugins\\function.cycle.php';
?><!-- CUSTOM -->
<div class="panel panel-default">                    
                    <div class="panel-body">
                        <form action="tbl_users/search" method="post" id="search_form">                     
                        <a href="tbl_users/create/" class="btn btn-success btn-sm">
                       ...
                       <h3 class="page-title">List of <?php echo $_smarty_tpl->tpl_vars['table_name']->value;?>
                        ...
                        <form action="tbl_users/delete" method="post" id="listing_form">
                          <div class="table-responsive">
                            <table class="table exportable" id="tbl_users" name="tbl_users">
                                <thead>
                                    <th> </th>
...
')" class="btn btn-danger btn-xs"><i class="fa fa-close" aria-hidden="true"></i></a>
                            ...
                            <div class="actions-bar wat-cf">
                                <div class="actions">
                                    ...
                                    <a href="tbl_users/index/0/all" class="btn btn-xs btn-success show-all"><i lass="fa fa-eye"></i> Show All</a>
                                    <?php }?>

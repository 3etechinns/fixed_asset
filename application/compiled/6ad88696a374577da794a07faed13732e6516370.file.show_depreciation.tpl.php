<?php /* Smarty version Smarty-3.1.7, created on 2018-02-11 22:49:54
         compiled from "C:\wamp64\www\fixed_asset\application\views\show_depreciation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:243605a80c789035251-39769373%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '243605a80c789035251-39769373',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a80c78911b3a',
  'variables' => 
  array (
    'id' => 0,
    'direction' => 0,
...
<?php if ($_valid && !is_callable('content_5a80c78911b3a')) {function content_5a80c78911b3a($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\wamp64\\www\\fixed_asset\\application\\libraries\\smarty\\plugins\\function.cycle.php';
...
">
        ...
        <a class="btn-default btn btn-sm pull-right <?php if (isset($_smarty_tpl->tpl_vars['direction']->value)){?><?php if ($_smarty_tpl->tpl_vars['direction']->value=='right'){?>disabled<?php }?><?php }?>"
           href="depreciation/navigate/right/<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
/show"><i class="fa fa-arrow-right"></i></a>
        <a class="btn-default btn btn-sm pull-right <?php if (isset($_smarty_tpl->tpl_vars['direction']->value)){?><?php if ($_smarty_tpl->tpl_vars['direction']->value=='left'){?>disabled<?php }?><?php }?>"
           href="depreciation/navigate/left/<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
:</td>
                    <td id="amount"><?php echo $_smarty_tpl->tpl_vars['depreciation_data']->value['dep_amount'];?>
</td>
                </tr>
                <tr class="<?php echo smarty_function_cycle(array('values'=>'odd,even'),$_smarty_tpl);?>
">
...
:</td>
                ...
                <tr class="<?php echo smarty_function_cycle(array('values'=>'odd,even'),$_smarty_tpl);?>
">
                    <td><?php echo $_smarty_tpl->tpl_vars['depreciation_fields']->value['book_value'];?>
:</td>
                    <td id="bookValue"><?php echo $_smarty_tpl->tpl_vars['depreciation_data']->value['book_value'];?>
</td>
                </tr>
                <tr class="<?php echo smarty_function_cycle(array('values'=>'odd,even'),$_smarty_tpl);?>
">
                    <td><?php echo $_smarty_tpl->tpl_vars['depreciation_fields']->value['accumulative_value'];?>
:</td>
                    <td id="accumulativeValue"><?php echo $_smarty_tpl->tpl_vars['depreciation_data']->value['accumulative_value'];?>
</td>
                </tr>
            </table>
        </div>

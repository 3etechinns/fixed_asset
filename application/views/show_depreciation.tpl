<div class="panel panel-default">
    <div class="panel-body">
        ...
        <a class="btn-default btn btn-sm pull-right {if isset($direction)}{if $direction == 'left'}disabled{/if}{/if}"
           href="depreciation/navigate/left/{$id}/show"><i class="fa fa-arrow-left"></i></a>
        ...
        <div class="col-sm-6">
            <table class="table table-bordered table-responsive" width="50%">
                ...
                <tr class="{cycle values='odd,even'}">
                    ...
                    <td id="amount">{$depreciation_data.dep_amount}</td>
                </tr>
                <tr class="{cycle values='odd,even'}">
                ...
                <tr class="{cycle values='odd,even'}">
                    <td>{$depreciation_fields.book_value}:</td>
                    <td id="bookValue">{$depreciation_data.book_value}</td>
                </tr>
                <tr class="{cycle values='odd,even'}">
                    <td>{$depreciation_fields.accumulative_value}:</td>
                    <td id="accumulativeValue">{$depreciation_data.accumulative_value}</td>
                </tr>
            </table>
        </div>
    </div><!-- .inner -->

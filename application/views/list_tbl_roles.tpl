                                ...
                                <tbody>
                                    {foreach $tbl_roles_data as $row}
                                        <tr class="{cycle values='odd,even'}">
                                            ...
                                            <a href="tbl_roles/show/{$row.roleId}" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="tbl_roles/edit/{$row.roleId}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                             <a href="javascript:chk('tbl_roles/delete/{$row.roleId}')" class="btn btn-danger btn-xs"><i class="fa fa-close" aria-hidden="true"></i></a>
                                             </div>
                                            </td>
                                        </tr>
                                    {/foreach}

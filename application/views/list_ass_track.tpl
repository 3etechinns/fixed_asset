...
<div class="panel panel-default">                    
			...
			<th>{$ass_track_fields.Asset_ass_id}</th>
                                ...
                                <tbody>
                                    {foreach $ass_track_data as $row}
                                        <tr class="{cycle values='odd,even'}">
                                            <td><input type="checkbox" class="checkbox" name="delete_ids[]" value="{$row.ass_track_id}" /></td>
				...
				<td>{$row.Asset_ass_id}</td>
                                            ...
                                            <a href="ass_track/show/{$row.ass_track_id}" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="ass_track/edit/{$row.ass_track_id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                             <a href="javascript:chk('ass_track/delete/{$row.ass_track_id}')" class="btn btn-danger btn-xs"><i class="fa fa-close" aria-hidden="true"></i></a>
                                             </div>
                                            </td>
                                        </tr>
                                    {/foreach}

...
<div class="panel panel-default">                    
                    <div class="panel-body">
                        ...
                        <a href="tbl_reset_password/create/" class="btn btn-success btn-sm">
			...
			<th>{$tbl_reset_password_fields.updatedDtm}</th>
				...
				<td>{$row.updatedDtm}</td>
                                            ...
                                            <a href="tbl_reset_password/show/{$row.id}" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="tbl_reset_password/edit/{$row.id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                             <a href="javascript:chk('tbl_reset_password/delete/{$row.id}')" class="btn btn-danger btn-xs"><i class="fa fa-close" aria-hidden="true"></i></a>
                                             </div>
                                            </td>
                                        </tr>
                                    {/foreach}
                            ...
                            <div class="actions-bar wat-cf">
                                <div class="actions">
                                    ...
                                    {if $showall==0}
                                    <a href="tbl_reset_password/index/0/all" class="btn btn-xs btn-success show-all"><i lass="fa fa-eye"></i> Show All</a>
                                    {/if}

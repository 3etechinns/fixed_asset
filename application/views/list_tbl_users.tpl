...
<div class="panel panel-default">                    
			...
			<th>{$tbl_users_fields.updatedDtm}</th>
				...
				<td>{$row.updatedDtm}</td>
                                            ...
                                            <a href="tbl_users/show/{$row.userId}" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="tbl_users/edit/{$row.userId}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                             <a href="javascript:chk('tbl_users/delete/{$row.userId}')" class="btn btn-danger btn-xs"><i class="fa fa-close" aria-hidden="true"></i></a>
                                             </div>
                                            </td>
                                        </tr>
                                    {/foreach}

        ...
        <form class="form" method='post' action='ass_track/{$action_mode}/{if isset($record_id)}{$record_id}{/if}'
            ...
            <div id="formContainer" class="col-sm-12">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"
                               for="track_model_number">{$ass_track_fields.track_model_number}
                            <span
                                    class="error">*</span></label>
                        <div class="col-md-6">
                            <input placeholder="Enter {$ass_track_fields.track_model_number}" class="form-control"
                                   type="text"
                                   required="required"
                                   maxlength="50"
                                   value="{if isset($ass_track_data)}{$ass_track_data.track_model_number}{/if}"

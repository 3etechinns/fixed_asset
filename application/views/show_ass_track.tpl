<div class="panel panel-default">
               ...
               <a href="ass_track/edit/{$id}"> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</button></a>
               ...
               <a class="btn-default btn btn-sm pull-right {if isset($direction)}{if $direction == 'right'}disabled{/if}{/if}" href="ass_track/navigate/right/{$id}/show"><i class="fa fa-arrow-right"></i></a>
                         <a class="btn-default btn btn-sm pull-right {if isset($direction)}{if $direction == 'left'}disabled{/if}{/if}" href="ass_track/navigate/left/{$id}/show"><i class="fa fa-arrow-left"></i></a>
						...
						<table class="table" width="50%">
                            ...
                            <td>{$ass_track_fields.current_value}:</td>

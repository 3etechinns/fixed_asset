...
class MY_Controller extends CI_Controller
{
    ...
    function displaySearchForm()
    {
        ...
        $searchResultMsg = '';
        //var_dump($startDate);
        $searchForm = '<div class="input-group" css="width:600px;float:right">';
        ...
        if (isset($searchResultMsg) && !empty($searchResultMsg)) {
            $searchForm .= '<div class="" css="display:block;width:100%;margin-top:10px">
            <span id="searchResult" name="searchResult" css="display: block;padding: 6px;
